...
int main(int argc, char *argv[])
{
    ...
    else if (strategy == "PAIRS" && argc == 10)
    {
        ...
        double pnl = pairs_plus_strategy(data1, data2, CashFlow, order_stats1, order_stats2, stoi(x), stoi(n), stod(threshold), stod(stop_loss_threshold));
...
cout << "Best Strategy is :- " << best_strategy << endl;
